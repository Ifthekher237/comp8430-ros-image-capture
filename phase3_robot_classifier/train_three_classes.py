...
def parse_args():
    ...
    p.add_argument('--robot-dir',   default='../dataset/robot_split',
                   help='Robot split directory (all 20 classes)')
    p.add_argument('--output-dir',  default='../dataset/three_class_robot',
